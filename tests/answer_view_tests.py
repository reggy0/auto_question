...
class AnswersTest(BaseTest):
    def post_answer_for_question_kind(self, kind, is_sms=False):
        ...
        response = self.client.post(
            url_for('answer', question_id=question_id), data=self.data
        )
    ...
    def test_redirects_to_next_question_after_saving(self):
        ...
        self.assertEquals([next_question_url], root.xpath('./Redirect/text()'))
        self.assertEquals(['GET'], root.xpath('./Redirect/@method'))
    ...
    def test_thanks_user_on_last_answer(self):
        ...
        self.assertEquals([thank_you_text], root.xpath('(./Say|./Message)/text()'))
    ...
    def test_transcription_callback_will_update(self):
        ...
        self.client.post(
            url_for('answer_transcription', question_id=question.id), data=self.data
        )
